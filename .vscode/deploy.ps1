...
if (-not (Test-Path sil-more-windows-sdl3/lib)) {
    ...
    if (Test-Path sil-more-windows-sdl3/lib/xtra/sound) {
        Remove-Item -Recurse -Force sil-more-windows-sdl3/lib/xtra/sound
    }
    Copy-Item -Recurse lib/xtra/sound sil-more-windows-sdl3/lib/xtra/sound -Force
}

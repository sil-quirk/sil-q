    ...
    int* out_count)
{
    ...
    button_w = sdl_touch_pane_clampf((float)view->cell_w * 6.1f, 66.0f,
        96.0f);
    button_h = sdl_touch_pane_clampf((float)view->cell_h * 2.35f, 36.0f,
        54.0f);
    ...
    radius = sdl_touch_pane_clampf(larger * 1.28f, 76.0f, 126.0f);

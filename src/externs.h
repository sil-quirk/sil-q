...
extern bool get_sdl_android_narrative_portrait_layout(void);
extern void set_sdl_android_narrative_portrait_layout(bool value);
...
extern int sdl_touch_top_panel_physical_button_capacity(bool second_row);

...
extern bool depleted_light_p(const object_type* o_ptr);
extern byte depleted_light_attr(const object_type* o_ptr);
extern char depleted_light_char(const object_type* o_ptr);

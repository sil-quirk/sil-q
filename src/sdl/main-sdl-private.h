...
SDL_FRect sdl_welcome_measure_story_text(const SDL_Rect* canvas, int col, int row, int max_cols, cptr text);
void sdl_welcome_bounds_add(sdl_welcome_picture_bounds* bounds, SDL_FRect rect);
void sdl_welcome_bounds_add_text(sdl_welcome_picture_bounds* bounds, const SDL_Rect* canvas, int col, int row, int max_cols, cptr text);
SDL_FRect sdl_welcome_draw_story_text(const SDL_Rect* canvas, int col, int row, int max_cols, cptr text, byte attr, float x_offset);
SDL_FRect sdl_welcome_story_text_span_rect(const SDL_Rect* canvas, int col, int row, int max_cols, cptr text, int start, int end, float x_offset);
SDL_FRect sdl_welcome_draw_story_text_span(const SDL_Rect* canvas, int col, int row, int max_cols, cptr text, int start, int end, byte attr, float x_offset);
...
void sdl_narrative_banner_draw_line(TTF_Font* font, cptr text, SDL_Color color, float center_x, float y, float max_w, float line_h);
...
void sdl_object_tooltip_append_part(char* buf, size_t buflen, cptr text);
bool sdl_object_tooltip_feature_name(int y, int x, cptr* out_name);
void sdl_object_tooltip_monster_morale_text(monster_type* m_ptr, char* out, size_t out_len);
bool sdl_object_tooltip_format_grid(int y, int x, char* out, size_t out_len);
...
void sdl_character_panel_show_hover_tooltip(int col, int row, int attack_mode, int click_action);
...
void sdl_touch_hidden_indicator_render_top(const SDL_Rect* screen, float size, SDL_Color fill, SDL_Color outline);
...
float sdl_touch_tutorial_draw_header_below(const SDL_Rect* screen, cptr title, cptr body, int page, int page_count, float min_y);
